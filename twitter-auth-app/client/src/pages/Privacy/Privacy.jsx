...
const privacyDocument = () => (
  <>
    ...
    <p>
      ...
      help of the{" "}
      <a href="https://www.privacypolicies.com/blog/privacy-policy-template/">
    ...
    <ul>
      ...
      <li>
        <p>
          ...
          the Company downloaded by You on any electronic device, named Twitter
          Firehose
        </p>
      </li>
      <li>
        <p>
          ...
          this Agreement) refers to Twitter Firehose, Professor Dr. Helmert
          Straße 2-3, 14482 Potsdam.
        </p>
      </li>
      <li>
        <p>
      ...
      <li>
        <p>
          <strong>Website</strong> refers to Twitter Firehose, accessible from{" "}
          <a href={`${DOMAIN_NAME}`} rel="external nofollow noopener">
            {DOMAIN_NAME}
          </a>
        </p>
      </li>
